...
class CommentedScene(CodeScene):
    def construct(self):
        ...
        self.add_background(f"/Users/mac/code-video-generator/examples/resources/blackboard.jpg")

        # Display the code and animate comments as highlighted lines. For more control,
        # use highlight_line(s) directly.
        self.animate_code_comments(f"/Users/mac/code-video-generator/commented.py", keep_comments=True, start_line=6, end_line=18)
        # end
