...
def title_scene(scene):
    ...
    scene.add_background(f"/Users/mac/code-video-generator/examples/resources/blackboard.jpg")
...
class Main(CodeScene):
    def construct(self):
        self.add_background_music(f"/Users/mac/code-video-generator/examples/resources/Pure Magic - Chris Haugen.mp3")
        title_scene(self)
        overview(self)
